        ...
        <div className="addSales">
            <div className="addSales-form">
                ...
                <div className="addSales-form-input">
                    ...
                    <input type="text" placeholder="Title" id="title" onChange={
                        (e) => {
                ...
                <div className="addSales-form-input">
                    ...
                    <input type="text" placeholder="Description" id="desc" onChange={
                        (e) => {
                ...
                <div className="addSales-form-input">
                    ...
                    <input type="text" placeholder="Price" id="price" onChange={
                        (e) => {
                ...
                <div className="addSales-form-input">
                    ...
                    <input type="text" placeholder="Image" id="image" onChange={
                        (e) => {
                ...
                <div className="addSales-form-input">
                    ...
                    <input type="text" placeholder="Sale Price" id="Sale" onChange={
                        (e) => {
